    ...
    return (
        <div>
            ...
            <div className='grid lg:grid-cols-2 gap-3 lg:px-24 lg:py-5 px-3'>
                {
                    jobsData.map(job => <JobData key={job.id} job={job}></JobData>)
                }
            </div>
            <div className='text-center mt-10 mb-20'>
                <button className='text-white text-lg font-semibold px-2 py-2 rounded bg-gradient-to-r  from-blue-400 to-violet-500'>See All Jobs</button>
            </div>
        </div>
    );
};
